/* ============================================================
   CONTRATACION-FLANDES · REQUERIMIENTOS (entrega 5.4)
...
(function () {
  ...
  function redactar(destinos, alTerminar) {
    ...
    cuerpo.appendChild(K.nodo('<p class="formulario__nota">' + K.icono('campana', 13) +
      ' Le llega como notificación en la app CONTRATISTA y por WhatsApp, y queda en MIS NOTIFICACIONES. Sale con tu nombre como Contratación.</p>'));
