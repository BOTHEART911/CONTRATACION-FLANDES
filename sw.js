/* ============================================================
   CONTRATACION-FLANDES · SERVICE WORKER DEL CACHÉ
   Entrega 5.1 (el mismo de CONTRATISTA-FLANDES, con el armazón de esta app)
...
var VERSION = 'contratacion-v' + APP_VERSION;
...
var PREFIJO_CACHE = 'contratacion-v20';   /* '-v20': la vieja de producción usa 'contratista-v3' y no es de esta */
